...
import { LayoutGrid, Hash, Plus, Settings, Search, ChevronDown, Wifi } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ rooms, activeRoomId, onSelectRoom, isConnected }) => {
  return (
